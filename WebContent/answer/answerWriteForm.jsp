...
<body>
	...
	<h3 id="qnaTitle">답변</h3>
		<form method="post" action="<%=request.getContextPath()%>/answer/answerWriteOk.do">
			<input type="submit" value="답변 등록" id="qnainsertBtn" class="btn btn-outline-dark btn-sm"/>
			<div class="form-group row" id="qnaContent">
				<textarea type="text" id="comment" name="comment" class="form-control col-sm-10"></textarea>
				<script>
